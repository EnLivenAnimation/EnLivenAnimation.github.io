...
let texture, texture2, sprite, button, button2, button3, button4, button5, button6, button7, button8, x, y, w, h, a;

function setup() {
    var stuff = [212,320,83,266];
    let tmp = PIXI.Texture.from("justin-sheet.png");
    let texture2 = PIXI.Texture.from("button.jpg");
    let texture3 = PIXI.Texture.from("button.jpg");
    let texture4 = PIXI.Texture.from("button.jpg");
    let texture5 = PIXI.Texture.from("button.jpg");
    let texture6 = PIXI.Texture.from("button.jpg");
    let texture7 = PIXI.Texture.from("button.jpg");
    let texture8 = PIXI.Texture.from("button.jpg");
    let texture9 = PIXI.Texture.from("button.jpg");
